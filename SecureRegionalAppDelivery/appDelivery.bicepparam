...
param certificates = [
      {
        ...
        value: loadFileAsBase64('./sslCert_contosoairlines_1.pfx')
        password: 'contosoairlines' // or leaver blank if not needed
      }
     {
        name: 'certContosoAirlines2' 
        value: loadFileAsBase64('./sslCert_contosoairlines_2.pfx')
        password: 'contosoairlines' // or leaver blank if not needed
      }
    ]
